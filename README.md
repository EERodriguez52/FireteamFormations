# FireteamFormations
FireteamFormations provides an easy to understand visualization of the standard
patrolling formations used by the USMC infantry. Using the menu provided on the left,
users are able to select a formation to view, and use the drop down menu to select 
